        ...
        >
            ...
            >
                <Typography
                    ...
                    sx={{
                        fontWeight: 500,
                        fontSize: { xs: 'var(--body-font-size)', sm: 'var(--subheading2-font-size)' },
                        lineHeight: { xs: 'var(--body-line-height)', sm: 'var(--subheading2-line-height)' },
                ...
                {helperText && (
                    <Typography
                        sx={{
                            fontSize: { xs: 'var(--label-font-size)', sm: 'var(--body-font-size)' },
                            lineHeight: 1.2,
                            color: error
