      ...
      >
        ...
        <Box sx={{ display: { xs: 'none', md: 'flex' }, gap: 3, alignItems: 'center' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.6 }}>
            ...
            <ExpandMoreIcon sx={{ color: 'var(--Black, #2C2C2C)', fontSize: 18 }} />
          </Box>
      ...
      <Container maxWidth='lg' sx={{ py: 5 }}>
          ...
          <Box sx={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
            <Box sx={{ minWidth: 140 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Features</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Pricing</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Security</Link>
              </Box>
            </Box>
            <Box sx={{ minWidth: 140 }}>
              <Typography sx={headingSx}>Company</Typography>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>About Us</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Careers</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Contact</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Customers</Link>
              </Box>
            </Box>
            <Box sx={{ minWidth: 140 }}>
              <Typography sx={headingSx}>Resources</Typography>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Help Center</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Blog</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Docs</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>API</Link>
              </Box>
            </Box>
            <Box sx={{ minWidth: 140 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                ...
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Cookies</Link>
                <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>GDPR</Link>
              </Box>
            </Box>
          </Box>
        </Box>
        ...
        <Box sx={{ mt: 4, pt: 3, borderTop: '0.5px solid #FFFFFF' }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 2, flexWrap: 'wrap', alignItems: 'center' }}>
            <Typography sx={{ color: 'rgba(255,255,255,0.72)', fontSize: '12px' }}>
              ©2025 Workonnect.ai. All rights reserved.
            </Typography>
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', alignItems: 'center' }}>
              <Link component={RouterLink} to='/privacy-policy' sx={linkSx}>Privacy</Link>
              <Typography sx={{ color: 'rgba(255,255,255,0.72)', lineHeight: 1 }}>•</Typography>
              <Link component={RouterLink} to='/terms' sx={linkSx}>Terms</Link>
              <Typography sx={{ color: 'rgba(255,255,255,0.72)', lineHeight: 1 }}>•</Typography>
              <Link href='#' onClick={e => e.preventDefault()} sx={linkSx}>Cookies</Link>
            </Box>
